...
for container in laptop_containers:
    ...
    original_price = container.select_one("div.BfVC2z > div.cN1yYO > div.hl05eU div.ZYYwLA")
    laptop_original_price = original_price.text.strip() if original_price else "N/A"

    # Extract discounted price
    discounted_price = container.select_one("div.BfVC2z > div.cN1yYO div._4b5DiR")
    laptop_discounted_price = discounted_price.text.strip() if discounted_price else "N/A"

    # Extract discount percentage
    discount = container.select_one("div.BfVC2z > div.cN1yYO > div.hl05eU div.UkUFwK")
    ...
    laptop_bank_offers = "Yes" if bank_offers else "No"
